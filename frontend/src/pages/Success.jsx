...
const Success = () => {
  ...
  return (
    <div className='m-2 w-full max-w-md bg-green-200 p-4 py-5 rounded mx-auto flex flex-col justify-center items-center gap-5'>
        ...
        <Link to="/dashboard/myorders" className="border border-green-900 text-green-900 hover:bg-green-900 hover:text-white transition-all px-4 py-1">Check Your Order Status</Link>
    </div>
  )
}
